<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" height="{{ $size }}" width="{{ $size }}" aria-labelledby="title" xmlns:xlink="http://www.w3.org/1999/xlink">
    ...
    <path data-name="layer1" d="M27.96 32.186L12.285 47.861l-5.245.983-4.429 9.995 2 2 10.243-4.181 1.029-5.291 15.629-15.629"
        fill="none" stroke="{{ $colour }}" stroke-miterlimit="10" stroke-width="{{ $width }}"
        stroke-linejoin="round" stroke-linecap="round">
    </path>

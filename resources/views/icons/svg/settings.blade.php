...
height="{{ $size }}" width="{{ $size }}">
  ...
  cx="26" cy="38" r="9" fill="none" stroke="{{ $colour }}" stroke-linecap="round"
  stroke-miterlimit="10" stroke-width="{{ $width }}" stroke-linejoin="round"></circle>
  <circle data-name="layer1" cx="45" cy="19" r="6" fill="none"
  stroke="{{ $colour }}" stroke-linecap="round" stroke-miterlimit="10" stroke-width="{{ $width }}"
  ...
  fill="none" stroke="{{ $colour }}" stroke-linecap="round" stroke-miterlimit="10"
  stroke-width="{{ $width }}" stroke-linejoin="round"></path>
